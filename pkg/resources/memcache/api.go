...
// MemcacheAPI - Cloud Memorystore for Memcached API v1. Instances are
// location-scoped (location_id is a GCP region). create/delete are long-running
// operations (return an Operation to poll); get/list return the resource directly.
...
// MemcacheOperations - asynchronous (LRO). create/delete return an Operation;
...
// extractMemcacheNativeID builds the resource path. On async create the response
