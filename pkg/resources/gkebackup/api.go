...
// extractGKEBackupNativeID builds the resource path. On async create the
...
func extractGKEBackupNativeID(response map[string]interface{}, ctx base.PathContext) string {
	if ctx.ResourceName != "" {
